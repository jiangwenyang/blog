...
date: 2021-09-22
image: 一个真实的vue-cli项目迁移到vite.webp
summary: 需要迁移到Vite的理由，并以真实项目为例，详细介绍从vue-cli迁移到Vite的可能会遇到的问题，以及如何解决这些问题
---
...
- [https://github.com/vitejs/vite/issues/3283](https://github.com/vitejs/vite/issues/3283)
- [https://github.com/nuxt/vite/issues/117](https://github.com/nuxt/vite/issues/117)
